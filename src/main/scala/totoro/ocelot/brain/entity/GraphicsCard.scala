...
import totoro.ocelot.brain.entity.traits.{DeviceInfo, GPULike, Tiered}
...
class GraphicsCard(override var tier: Int) extends Environment with DeviceInfo with Tiered with GPULike {
