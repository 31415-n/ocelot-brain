...
import li.cil.oc.server.component.{UpgradeSign, UpgradeSignInAdapter, UpgradeSignInRotatable}
...
object DriverUpgradeSign extends Item with HostAware {
  ...
  override def createEnvironment(stack: ItemStack, host: EnvironmentHost): UpgradeSign =
    host match {
