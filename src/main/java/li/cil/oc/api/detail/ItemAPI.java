...
public interface ItemAPI {
    /**
     * Get a descriptor object for the item with the specified name.
     * <p/>
     * An info object can be used to retrieve the instance of the
    ...
    /**
     * Get a descriptor object for the item represented by the
     ...
     * if the stack is not a valid OpenComputers item.
     */
    @Nullable
